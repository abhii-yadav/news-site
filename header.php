  ...
  $page = basename($_SERVER['PHP_SELF']);//to check which file is passing in url we use $_SERVER['PHP_SELF']
  //here basename is php function which give proper file name eg. /news-site/category.php give only category.php
  switch($page){
    case "single.php":
      if(isset($_GET['id'])){
